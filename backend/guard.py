...
". За неимѣнием вашей свѣтлости я выбралъ %(default)s."
    ...
    ("-k", "--key"):
    {
        ...
        "metavar": "КЛЮЧИКЪ",
        "help": """
Ключъ шифрованiя. Не будучи переданъ вашимъ сiятельствомъ, будетъ выдуманъ мною.
"""
    },
    ...
    ("-o", "--output"):
    {
        ...
        "metavar": "ЗАГЛАВIЕ",
        "help": """
Названiе опуса, на коемъ я начертаю шифръ. Безъ названiя просто произнесу сообщенiе.
"""
    }
